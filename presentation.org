...
#+begin_quote
“[Ninja] designed to have its input files generated by a higher-level build system.  ... human-readable but not especially convenient to write by hand.”
#+end_quote

* Part 3 -- Meta-build System

* Why meta-build systems?

- Natural evolution of build systems
- Cross-platform, cross-IDE solution
